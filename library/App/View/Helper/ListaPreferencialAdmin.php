 ...
 */
class App_View_Helper_ListaPreferencialAdmin extends Zend_View_Helper_HtmlElement
{
  
    public function ListaPreferencialAdmin(
        $idElement, $numeroAvisos, $dataPosicion = null, $dataAttribs = null, $js = true
    )
    {
        $values = array();
        $href = "#";
